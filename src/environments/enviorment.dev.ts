export const environment = {
  production: true,
  API_URL: 'http://contables.unicauca.edu.co:443/dev/api/',
  ...
  keycloak_url: 'http://contables.unicauca.edu.co:443/dev/api/keycloak/token/',
  URL: 'http://contables.unicauca.edu.co:443/dev/',
